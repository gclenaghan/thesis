...
\begin{example}
	...
	By proposition \ref{prp:cohofdual}, this is $\HH^i(X_\bullet, \pi_\bullet^* \LL^{-1})$, which we can now compute directly.
	...
	On $k$ it is the only possible line bundle, $k$ over itself, and thus by the diagram commuting, on $Y$ the pullback is $\OO_Y$.
