...
\begin{proof}
	...
	\[
		...
		\end{tikzcd}
	\]
	Then we must show that for $s \otimes t$ in $\FF_\alpha \otimes^p \GG_\alpha$, $\cH_\phi (\psi_\alpha(s)(t)) = \psi_\beta(\FF_\phi s)(\GG_\phi t)$.
	This can be seen as a result of the compatibilities of the map $\psi$.
\end{proof}
