...
\begin{definition}
	Let $X_\bullet$ be an $I$-scheme and $\alpha \in I$. Define an object in the derived category of diagrams of sheaves on $X_\alpha$ over $I^{op}$ as $\hat{\omega}_\bullet^\alpha \in D(X_\bullet)$
	\[
		\hat{\omega}^\alpha_\beta =  \begin{cases}
									...
									\end{cases}
	\]
	where the diagram maps are the pushforwards of the natural maps $\bR X_{\phi_{\gamma \beta} *} \omega_{X_\gamma}^\bullet \rightarrow \omega_{X_\beta}$.
\end{definition}

\begin{theorem}
	For any $X_\bullet$ an $I$-scheme over a field $k$, and $\alpha \in I$, there is a natural isomorphism
	\[
		(\omega_{X_\bullet}^\bullet)_\alpha = \bR \varprojlim_{I^{op}} \hat{\omega}^\alpha_\bullet
	\]
\end{theorem}
\begin{proof}
	...
	\begin{align*}
		\Hom(F, (\omega_{X_\bullet}^\bullet)_\alpha) &= \bR \varprojlim_{\beta \in I^{op}} \Hom(F, \hat{\omega}^\alpha_\beta) \\
		&= \Hom(F, \bR \varprojlim_{I^{op}} \hat{\omega}^\alpha_\bullet).
	\end{align*}
\end{proof}
