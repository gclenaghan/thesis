...
\begin{document}
\title{Grothendieck Duality on Diagrams of Schemes}
\maketitle
\begin{abstract}
	The Du Bois complex and Du Bois singularities, extending results of Hodge theory to singular complex varieties, are defined in terms of a hyperresolution, which for our purposes is a cubical diagram of schemes resolving the singularities of the variety of interest.
	To study this, in this dissertation I further develop the language of diagrams of schemes and then prove analogues of Grothendieck duality and other cohomological theorems.
...
The Du Bois complex is a generalization of the De Rham complex, appearing in Hodge theory, to singular complex varieties, and was introduced in \cite{Bois1981}.
The definition takes the De Rham complexes of smooth varieties and pushes them down to singular varieties, but unfortunately a traditional resolution of singularities is inadequate for this process, leading to the notion of a ``hyperresolution" which is better at ``remembering" the topological information that a traditional resolution will lose.
