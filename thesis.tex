...
\begin{theorem}[6.5 of \cite{Kollar2013}]
	...
	\begin{enumerate}
		...
		\item If $X$ is proper, there is a spectral sequence degenerating at $E_1$ and computing the singular cohomology with compact support of $X$
		\[
...
\section{Cohomology of Blowdowns}
\begin{theorem}
...
\begin{proof}
	...
	Thus for $0 < i < n-2$, $H^i(Y_p, \DB_{Y_p}^0) = H^{i+1}(X_\bullet, \pi_\bullet^* \LL^{-1}) = 0$.
\end{proof}
