...
\begin{definition}[\cite{Guillen1988} I 6]
	Let $F_\bullet : \Box_n \rightarrow C(A)$ be a diagram in the category of complexes in an abelian category $A$, where the differential of $F_\alpha$ is $d_\alpha$.
...
\begin{prop}[\cite{Guillen1988} I 6.3, developed further in \cite{Guillen2002} 1.3.1, \cite{Pascual2009} 2.1]
